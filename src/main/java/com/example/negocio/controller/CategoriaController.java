...
public class CategoriaController {
    ...
    @PostMapping("/nueva")
    public ResponseEntity<Categoria> nuevaCategoria(@RequestBody CategoriaDTO dto) {
        return ResponseEntity.ok(categoriaService.nuevaCategoria(dto));
    }

    @PutMapping("/modificar/{idCategoria}")
    public ResponseEntity<Categoria> modificarCategoria(@PathVariable Long idCategoria, @RequestBody CategoriaDTO dto) {
